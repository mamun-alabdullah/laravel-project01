                        ...
                        <div class="navbar-cart">
                            ...
                            <div class="cart-items">
                                <a href="javascript:void(0)" class="main-btn">
                                    ...
                                    <span class="total-items">{{count($cartProducts)}}</span>
                                </a>
                                ...
                                <div class="shopping-item">
                                    ...
                                    <ul class="shopping-list">
                                        ...
                                        <li>
                                            ...
                                            <div class="content">
                                                <h4><a href="">
                                                        {{$cartProduct->name}} - ({{$cartProduct->price}} * {{$cartProduct->quantity}})</a></h4>
                                                <p class="quantity"><span class="amount">Tk. {{$cartProduct->price * $cartProduct->quantity}}</span></p>
                                            </div>
                                        </li>
